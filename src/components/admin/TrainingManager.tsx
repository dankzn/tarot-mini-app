...
const buildLessonTemplate = (count: number) =>
  Array.from({ length: count }, (_, index) => ({
    title: `Занятие ${index + 1}`,
    homework: 'Домашнее задание будет добавлено в программу курса.',
  }));

const TRAINING_LESSON_TEMPLATES: Record<string, Array<{ title: string; homework: string }>> = {
  'individual-basic': buildLessonTemplate(10),
  'group-basic': buildLessonTemplate(10),
  'individual-advanced': buildLessonTemplate(14),
};
