...
const NOTO_SANS_REGULAR_PATH = join(__dirname, '../../public/telegram/fonts/NotoSans-Regular.ttf');
const NOTO_SANS_SEMIBOLD_PATH = join(__dirname, '../../public/telegram/fonts/NotoSans-SemiBold.ttf');
