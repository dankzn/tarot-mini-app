...
insert into public.training_programs (
  ...
  (
    ...
    20000,
    'индивидуальный темп',
    array['Личная траектория', 'Практика на ваших вопросах', 'Базовые расклады', 'Поддержка между встречами'],
    false,
    10
  ),
  (
    ...
    array['Глубокие связки арканов', 'Сложные расклады', 'Этика консультаций', 'Разбор практики'],
    false,
    20
  ),
  (
    ...
    11500,
    'старт по группе',
    array['Камерная группа', 'Практика в парах', 'Домашние задания', 'Общий учебный ритм'],
    true,
    30
  )
